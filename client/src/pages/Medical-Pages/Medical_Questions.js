...
import Translator from '../../../utils/api';
...
const Medical_Questions = () => {
    ...
    return (
        <div>
            ...
            <h3> Medical issues? Ex Diabetes, Prior hart attack etc.
            </h3>
            <h3>  Medical issues? Ex Diabetes, Prior hart attack etc.
            </h3>  <input placeholder = "enter info here"/>
            <button onClick={"? write the function "}>Done</button>
